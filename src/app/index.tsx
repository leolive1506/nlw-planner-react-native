...
import { MapPin, Calendar as IconCalendar, Settings2Icon, Settings2, UserRoundPlus, ArrowRight } from "lucide-react-native" 
          ...
          <View>
            <View className="border-b py-3 border-zinc-800">
              <Button variant="secondary" onPress={() => setStepForm(StepForm.TRIP_DETAILS )}>
                <Button.Title>Alterar location/data</Button.Title>
